...
<script>
    var disqus_config = function () {
        // 아래 라인들을 삭제하여 기본 정보를 제거하세요
        this.language = "ko"; // 언어를 "ko" 또는 다른 언어 코드로 설정하세요
        this.callbacks.onReady = [function() {
            // 구독, 개인정보 보호 등의 정보를 제거하기 위해 아래 코드 추가
            var iframe = document.getElementsByClassName('disqus-frame')[0];
            iframe.onload = function() {
                var disqusBody = iframe.contentDocument.body;
                disqusBody.getElementsByClassName('footer')[0].style.display = 'none';
            };
        }];
    };
    (function() {
